...
<%
    ...
    try {                                                                                                                                                                          // Establish a database connection
        ...
        String checkForTicketsQuery = "SELECT COUNT(*) AS available_tickets FROM TicketForFlight WHERE flight_number = ? AND ticket_id NOT IN (SELECT id FROM WaitingList)";                                                         
